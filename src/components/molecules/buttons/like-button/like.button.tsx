...
import { IconButton } from '../../../atoms/buttons/icon/icon.button';
...
export const LikeButton = ({ callback, liked }: ILikeButtonProps) => {
  return (
    <IconButton
      styles={liked ? 'text-red-400 w-6 h-auto fill-current' : 'text-gray-300 w-6 h-auto fill-current'}
      icon={
        liked
